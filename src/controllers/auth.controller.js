                  ...
                  <tr>
                    <td class="content-section">
                      ...
                      <div class="verify-button">
                        <a style="color:white;" class="button" href="http://localhost:3000/api/auth/verify?email=${req.body.email}&token=${token}"> Verify email </a>
                      </div>
                      <div class="content2">
                        If that doesn't work, please click <a href="http://localhost:3000/api/auth/verify?email=${req.body.email}&token=${token}">here</a>
                      </div>
                      <div class="content3">
                        Cheers, <br />
                        FU-BLOG
